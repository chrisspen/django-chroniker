...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Job.current_hostname'
        db.add_column(u'chroniker_job', 'current_hostname',
                      self.gf('django.db.models.fields.CharField')(max_length=700, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Job.hostname'
        db.alter_column(u'chroniker_job', 'hostname', self.gf('django.db.models.fields.CharField')(max_length=700, null=True))

    def backwards(self, orm):
        # Deleting field 'Job.current_hostname'
        db.delete_column(u'chroniker_job', 'current_hostname')


        # Changing field 'Job.hostname'
        db.alter_column(u'chroniker_job', 'hostname', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
