...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Log', fields ['success']
        db.create_index('chroniker_log', ['success'])

        # Adding index on 'Log', fields ['duration_seconds']
        db.create_index('chroniker_log', ['duration_seconds'])

        # Adding index on 'Log', fields ['run_end_datetime']
        db.create_index('chroniker_log', ['run_end_datetime'])
    ...
    def backwards(self, orm):
        ...
        # Removing index on 'Log', fields ['duration_seconds']
        db.delete_index('chroniker_log', ['duration_seconds'])

        # Removing index on 'Log', fields ['success']
        db.delete_index('chroniker_log', ['success'])

        # Removing index on 'Log', fields ['run_start_datetime']
        db.delete_index('chroniker_log', ['run_start_datetime'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 23, 17, 45, 47, 618313)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 23, 17, 45, 47, 618203)'}),
