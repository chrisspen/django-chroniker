...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Job.log_stdout'
        db.add_column(u'chroniker_job', 'log_stdout',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Job.log_stderr'
        db.add_column(u'chroniker_job', 'log_stderr',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Job.log_stdout'
        db.delete_column(u'chroniker_job', 'log_stdout')

        # Deleting field 'Job.log_stderr'
        db.delete_column(u'chroniker_job', 'log_stderr')
