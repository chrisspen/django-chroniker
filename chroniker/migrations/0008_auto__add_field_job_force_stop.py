...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Job.force_stop'
        db.add_column('chroniker_job', 'force_stop', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Job.force_stop'
        db.delete_column('chroniker_job', 'force_stop')
