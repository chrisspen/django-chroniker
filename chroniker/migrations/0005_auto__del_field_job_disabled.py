...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('chroniker_job', 'disabled')


    def backwards(self, orm):
        
        # Adding field 'Job.disabled'
        db.add_column('chroniker_job', 'disabled', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
