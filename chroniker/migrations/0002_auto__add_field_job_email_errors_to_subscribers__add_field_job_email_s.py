...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Job.email_errors_to_subscribers'
        db.add_column('chroniker_job', 'email_errors_to_subscribers', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'Job.email_success_to_subscribers'
        db.add_column('chroniker_job', 'email_success_to_subscribers', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Job.email_errors_to_subscribers'
        db.delete_column('chroniker_job', 'email_errors_to_subscribers')

        # Deleting field 'Job.email_success_to_subscribers'
        db.delete_column('chroniker_job', 'email_success_to_subscribers')
    ...
    models = {
        ...
        'chroniker.log': {
            ...
            'run_start_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
