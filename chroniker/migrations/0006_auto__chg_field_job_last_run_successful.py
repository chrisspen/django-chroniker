...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Job.last_run_successful'
        db.alter_column('chroniker_job', 'last_run_successful', self.gf('django.db.models.fields.NullBooleanField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Job.last_run_successful'
        db.alter_column('chroniker_job', 'last_run_successful', self.gf('django.db.models.fields.BooleanField')())
