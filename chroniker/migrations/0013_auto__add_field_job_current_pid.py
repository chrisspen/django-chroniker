...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Job.current_pid'
        db.add_column(u'chroniker_job', 'current_pid',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Job.current_pid'
        db.delete_column(u'chroniker_job', 'current_pid')
    ...
    models = {
        ...
        u'chroniker.job': {
            ...
            'current_pid': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
