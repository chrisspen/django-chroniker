...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('chroniker_job', 'enabled', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Job.enabled'
        db.delete_column('chroniker_job', 'enabled')
