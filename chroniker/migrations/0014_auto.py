...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Job', fields ['current_pid']
        db.create_index(u'chroniker_job', ['current_pid'])


    def backwards(self, orm):
        # Removing index on 'Job', fields ['current_pid']
        db.delete_index(u'chroniker_job', ['current_pid'])
