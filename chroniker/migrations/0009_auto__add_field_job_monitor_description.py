...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Job.monitor_description'
        db.add_column('chroniker_job', 'monitor_description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Job.monitor_description'
        db.delete_column('chroniker_job', 'monitor_description')
